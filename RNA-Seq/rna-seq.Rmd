...
Lets make some plots for them specifically for the pathway to keep them happy. 
...
Below is an example of the pdf() and dev.off() fucntions. You can apply these to any of these plots we have created during the tutorial. Simply wrap the plot function with pdf()....plot fn...dev.off(). 
```{R}
